...
FRIENDS = [
    ...
    "ZENI","REX","ARNAV","NOXNAME","OBITO","RAISEN","REXX",
...
def _lean_nc_factory(txt: str) -> callable:
    _sfx = [
        ...
        " 𝐋ᴜɴᴅ 𝐏ʀ 𝐔ᴄʜʜʟ 🍌𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫🍌𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🍌𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🍌𒐫𒐫 𒐫𒐫𒐫🍌𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫🍌𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🍌𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🍌𒐫𒐫.·", " 𝐋ᴜɴᴅ 𝐏ʀ 𝐔ᴄʜʜʟ 🍌𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫🍌𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🍌𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🍌𒐫𒐫 𒐫𒐫𒐫🍌𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫🍌𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🍌𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🍌𒐫𒐫··", " 𝐋ᴜɴᴅ 𝐏ʀ 𝐔ᴄʜʜʟ 🍌𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫🍌𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🍌𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🍌𒐫𒐫 𒐫𒐫𒐫🍌𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫🍌𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🍌𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🍌𒐫𒐫•·", " 𝐋ᴜɴᴅ 𝐏ʀ 𝐔ᴄʜʜʟ 🍌𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫🍌𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🍌𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🍌𒐫𒐫 𒐫𒐫𒐫🍌𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫🍌𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🍌𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🍌𒐫𒐫·•", " 𝐋ᴜɴᴅ 𝐏ʀ 𝐔ᴄʜʜʟ 🍌𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫🍌𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🍌𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🍌𒐫𒐫 𒐫𒐫𒐫🍌𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫🍌𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🍌𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🍌𒐫𒐫..", "  𝐋ᴜɴᴅ 𝐏ʀ 𝐔ᴄʜʜʟ 🍌𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫🍌𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🍌𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🍌𒐫𒐫 𒐫𒐫𒐫🍌𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫🍌𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🍌𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🍌𒐫𒐫·",
        " 𝐋ᴜɴᴅ 𝐏ʀ 𝐔ᴄʜʜʟ 🍌𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫🍌𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🍌𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🍌𒐫𒐫 𒐫𒐫𒐫🍌𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫🍌𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🍌𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🍌𒐫𒐫⌁", " 𝐋ᴜɴᴅ 𝐏ʀ 𝐔ᴄʜʜʟ 🍌𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫🍌𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🍌𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🍌𒐫𒐫 𒐫𒐫𒐫🍌𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫🍌𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🍌𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🍌𒐫𒐫∘", " 𝐋ᴜɴᴅ 𝐏ʀ 𝐔ᴄʜʜʟ 🍌𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫🍌𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🍌𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🍌𒐫𒐫 𒐫𒐫𒐫🍌𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫🍌𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🍌𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🍌𒐫𒐫∙", " 𝐋ᴜɴᴅ 𝐏ʀ 𝐔ᴄʜʜʟ 🍌𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫🍌𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🍌𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🍌𒐫𒐫 𒐫𒐫𒐫🍌𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫🍌𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🍌𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🍌𒐫𒐫⋅", " 𝐋ᴜɴᴅ 𝐏ʀ 𝐔ᴄʜʜʟ 🍌𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫🍌𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🍌𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🍌𒐫𒐫 𒐫𒐫𒐫🍌𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫🍌𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🍌𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🍌𒐫𒐫◦", " 𝐋ᴜɴᴅ 𝐏ʀ 𝐔ᴄʜʜʟ 🍌𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫🍌𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🍌𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🍌𒐫𒐫 𒐫𒐫𒐫🍌𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫🍌𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🍌𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🍌𒐫𒐫∵", " 𝐋ᴜɴᴅ 𝐏ʀ 𝐔ᴄʜʜʟ 🍌𒐫𒐫𒐫??𒐫??𒐫𒐫𒐫🍌𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🍌𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🍌𒐫𒐫 𒐫𒐫𒐫🍌𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫🍌𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🍌𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🧃𒐫𒐫𒐫🍌𒐫𒐫∶",
...
def _noxname_factory(txt: str, idx: int) -> callable:
    last = _last()
    fn   = _NOXNAME_TMPL[idx % len(_NOXNAME_TMPL)]
    def _f():
...
def _chud_nc_factory(txt: str) -> callable:
    """
    Template: {txt}𝐓ᴍᴋʙ 𝐑ʏɴᴅʏʏʏ𒐫𒐫𒐫💥𒐫💥𒐫𒐫𒐫💥💥{WORD} 𒐫𒐫𒐫💥𒐫💥𒐫𒐫𒐫 ➴ྀ࿐ ··
    ...
    def _f():
        ...
        c = (
            f"{txt}"
            f"𝐓ᴍᴋʙ 𝐑ʏɴᴅʏʏʏ𒐫𒐫𒐫𒐫𒐫𒐫💥𒐫💥𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫𒐫💥𒐫💥𒐫𒐫𒐫💥💥"
            f"{word} "
...
# ═══════════════════════════════════════════════════════════════════════════════
#  ⚔️  NOXNAME SIGNATURE ELITE NCs  ⚔️
...
def _akatsuki_factory(txt: str) -> callable:
    ...
    WORDS = ["𝐀𝐊𝐀𝐓𝐒𝐔𝐊𝐈","𝐏𝐀𝐈𝐍","𝐍𝐀𝐆𝐀𝐓𝐎","𝐊𝐎𝐍𝐀𝐍","𝐎𝐁𝐈𝐓𝐎","𝐈𝐓𝐀𝐂𝐇𝐈","𝐍𝐎 𝐍𝐀𝐌𝐄"]
    BURST = ["☁","🌩","⚡","🩸","💀","🌑"]
    ctr   = [0]; widx = [0]; bidx = [0]
...
def _madara_factory(txt: str) -> callable:
    ...
    WORDS = ["𝐌𝐀𝐃𝐀𝐑𝐀","𝐔𝐂𝐇𝐈𝐇𝐀","𝐆𝐎𝐃","𝐋𝐈𝐌𝐁𝐎","𝐑𝐈𝐍𝐍𝐄𝐆𝐀𝐍","𝐍𝐎 𝐍𝐀𝐌𝐄"]
    BURST = ["⭐","👑","🌟","💫","☄","🔱"]
    ctr   = [0]; widx = [0]; bidx = [0]
...
def _susanoo_factory(txt: str) -> callable:
    ...
    WRAP  = ("꧁", "꧂")
    WORDS = ["𝐒𝐔𝐒𝐀𝐍𝐎𝐎","𝐏𝐄𝐑𝐅𝐄𝐂𝐓","𝐀𝐑𝐌𝐎𝐑","𝐃𝐈𝐕𝐈𝐍𝐄","𝐔𝐂𝐇𝐈𝐇𝐀","𝐍𝐎 𝐍𝐀𝐌𝐄"]
    BURST = ["⚔","🛡","⚡","🔱","💥","🗡"]
    ctr   = [0]; widx = [0]; bidx = [0]
...
def _itachi_factory(txt: str) -> callable:
    ...
    WORDS = ["𝐈𝐓𝐀𝐂𝐇𝐈","𝐓𝐒𝐔𝐊𝐔𝐘𝐎𝐌𝐈","𝐀𝐌𝐀𝐓𝐄𝐑𝐀𝐒𝐔","𝐂𝐑𝐎𝐖","𝐆𝐄𝐍𝐉𝐔𝐓𝐒𝐔","𝐍𝐎 𝐍𝐀𝐌𝐄"]
    BURST = ["🪶","🌑","💀","🦅","🖤","⚫"]
    ctr   = [0]; widx = [0]; bidx = [0]
...
def _uchiha_factory(txt: str) -> callable:
    UNIT  = "ꙭ\u0488\u20dd"
    WORDS = ["𝐔𝐂𝐇𝐈𝐇𝐀","𝐍𝐎 𝐍𝐀𝐌𝐄","𝐎𝐁𝐈𝐓𝐎","𝐅𝐔𝐆𝐀𝐊𝐔","𝐌𝐈𝐊𝐎𝐓𝐎","𝐂𝐋𝐀𝐍"]
    BURST = ["👁","🔴","⚔️","💀","🌑","🩸"]
    ctr   = [0]; widx = [0]; bidx = [0]
...
def _chidori_factory(txt: str) -> callable:
    UNIT  = "ᛠ\u0488\u20df"
    WORDS = ["𝐂𝐇𝐈𝐃𝐎𝐑𝐈","𝐋𝐈𝐆𝐇𝐓𝐍𝐈𝐍𝐆","𝐁𝐋𝐀𝐃𝐄","𝐊𝐈𝐑𝐈𝐍","𝐓𝐇𝐔𝐍𝐃𝐄𝐑","𝐍𝐎 𝐍𝐀𝐌𝐄"]
    BURST = ["⚡","🔵","💙","🌩️","⚡","🔱"]
    ctr   = [0]; widx = [0]; bidx = [0]
...
def _amaterasu_factory(txt: str) -> callable:
    UNIT  = "ꫫ\u0489\u20de"
    WORDS = ["𝐀𝐌𝐀𝐓𝐄𝐑𝐀𝐒𝐔","𝐅𝐋𝐀𝐌𝐄𝐒","𝐁𝐋𝐀𝐂𝐊","𝐄𝐓𝐄𝐑𝐍𝐀𝐋","𝐔𝐂𝐇𝐈𝐇𝐀","𝐍𝐎 𝐍𝐀𝐌𝐄"]
    BURST = ["🔥","⚫","🖤","☄️","🌑","💀"]
    ctr   = [0]; widx = [0]; bidx = [0]
...
def _kirin_factory(txt: str) -> callable:
    UNIT  = "ᙘ\u0488\u20dd"
    WORDS = ["𝐊𝐈𝐑𝐈𝐍","𝐃𝐑𝐀𝐆𝐎𝐍","𝐒𝐓𝐎𝐑𝐌","𝐃𝐈𝐕𝐈𝐍𝐄","𝐓𝐇𝐔𝐍𝐃𝐄𝐑","𝐍𝐎 𝐍𝐀𝐌𝐄"]
    BURST = ["🐉","⚡","🌩️","🔱","☄️","💥"]
    ctr   = [0]; widx = [0]; bidx = [0]
...
def _cursemark_factory(txt: str) -> callable:
    UNIT  = "ꩤ\u0489\u0336"
    WORDS = ["𝐂𝐔𝐑𝐒𝐄","𝐒𝐄𝐀𝐋","𝐃𝐀𝐑𝐊𝐍𝐄𝐒𝐒","𝐏𝐎𝐖𝐄𝐑","𝐎𝐑𝐎𝐂𝐇𝐈","𝐍𝐎 𝐍𝐀𝐌𝐄"]
    BURST = ["🐍","💀","☠️","🌑","⚫","🩸"]
    ctr   = [0]; widx = [0]; bidx = [0]
...
_MENU_SECTIONS = [
    ...
    ("┌────── ⚔️ 𝐖ᴀʀ  𝐂ᴏɴᴛʀᴏʟ ──────┐\n"
     ...
     "│ -ᴜɴᴍᴜᴛᴇ      𝐔ɴᴍᴜᴛᴇ 𝐂ʜᴀᴛ   │\n"
     "└───────────────────────────────┘"),
    # 14 — NOXNAME ELITE NCs
    ("┌──── ⚔️ 𝐍ᴏ-ɴᴀᴍ𝐄 𝐄ʟɪᴛᴇ 𝐍ᴄ's ────┐\n"
...
def _make_elite_cmd(factory_fn, label: str, sym: str):
    ...
    async def _cmd(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
        ...
        await _reply(msg,
            f"╔══════════════════════════════════╗\n"
            f"  {sym*4} ⚔️ 𝑵𝑶𝑿𝑵𝑨𝑴𝑬 𝑬𝑳𝑰𝑻𝑬 𝑵𝑪 {sym*4}\n"
            f"  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
            f"  📛 𝘛𝘦𝘹𝘵:   {txt}\n"
            f"  ⚔️  𝘔𝘰𝘥𝘦:   {label}\n"
...
# ── NO NAME LEGEND NCs (5 new) — PRIME ENGINE ─────────────────────────────────
...
def _make_legend_cmd(factory_fn, label: str, sym: str):
    ...
    async def _cmd(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
        ...
        await _reply(msg,
            f"╔══════════════════════════════════╗\n"
            f"  {sym*4} ⚡ 𝑵𝑶𝑿𝑵𝑨𝑴𝑬 𝑳𝑬𝑮𝑬𝑵𝑫 𝑵𝑪 {sym*4}\n"
            f"  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
            f"  📛 𝘛𝘦𝘹𝘵:    {txt}\n"
            f"  ⚔️  𝘔𝘰𝘥𝘦:    {label}\n"
            f"  🤖 𝘉𝘰𝘵𝘴:    {len(bots)} (𝘙𝘰𝘶𝘯𝘥-𝘙𝘰𝘣𝘪𝘯)\n"
...
async def cmd_allcmds(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    text = (
        ...
        "  🔥 𝐍𝐂 𝐂𝐎𝐑𝐄\n"
        "  -𝐧𝐜  -𝐬𝐧𝐜  -𝐠𝐨𝐝  -𝐠𝐨𝐝1\n"
        "  -𝐛𝐢𝐠1  -𝐭𝐫𝐢𝐨𝐠𝐨𝐝  -𝐬𝐢𝐥𝐤𝐧𝐜  -𝐜𝐡𝐮𝐝\n"
        "  -𝐛𝐨𝐥𝐝𝐧𝐜  -𝐜𝐮𝐫𝐬𝐢𝐯𝐞𝐧??  -𝐢𝐭𝐚𝐥𝐢𝐜𝐧𝐜  -𝐰𝐚𝐯𝐞𝐧𝐜\n"
        "  -𝐝𝐞𝐚𝐝𝐧𝐜  -𝐧𝐧𝐜  -𝐫𝐚𝐧𝐝𝐨𝐦𝐜𝐨𝐝  -𝐠𝐨𝐝𝐜𝐨𝐝\n"
...
@_guard
async def cmd_zxncs(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    msg = update.message or update.edited_message
    if not msg:
        return
    cid = msg.chat_id
    txt = _txt_arg(ctx) or "NOXNAME"
    idx = [0]
    factories = [_noxname_factory(txt, i) for i in range(10)]
    def _cycling_factory():
        f = factories[idx[0] % len(factories)]
        idx[0] += 1
        return f()
    await _start_nc(msg, cid, _cycling_factory, f"⚡ All NO NAME NCs")
...
async def cmd_deadnc(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    if not msg:
        return
    txt = _txt_arg(ctx) or "NOXNAME"
    await _start_nc(msg, msg.chat_id, _dead_factory(txt), "♛ NO NAME NC")
...
async def cmd_nnc(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    await _start_nc(msg, msg.chat_id, _n_factory(txt), "𖤍 NO NAME NC")
...
@_guard
async def cmd_big1(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    msg = update.message or update.edited_message
    if not msg:
        return
    cid = msg.chat_id
    txt = _txt_arg(ctx)
    if not txt:
        await _reply(msg, "𝐔𝐬𝐞: -big1 <text>")
        return
    bots = _bots()
    if not bots:
        await _reply(msg, "⚡ 𝐍𝐨 𝐛𝐨𝐭𝐬 𝐚𝐯𝐚𝐢𝐥𝐚𝐛𝐥𝐞!")
    ...
    _nc_info[cid] = {"engine": "BIG1", "text": txt, "start_t": time.monotonic()}
...
@_guard
async def cmd_god1(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    msg = update.message or update.edited_message
    if not msg:
        return
    cid = msg.chat_id
    txt = _txt_arg(ctx)
    if not txt:
        await _reply(msg, "𝐔𝐬𝐞: -god1 <text>")
        return
    bots = _bots()
    if not bots:
        await _reply(msg, "⚡ 𝐍𝐨 𝐛𝐨𝐭𝐬 𝐚𝐯𝐚𝐢𝐥𝐚𝐛𝐥𝐞!")
        return
    gap = _nc_send_gap if _nc_send_gap is not None else 0.25
    _nc_info[cid] = {"engine": "NOXNAMEGOD", "text": txt, "start_t": time.monotonic()}

    async def _run(stop_ev):
        try:
            await _god_engine(cid, bots, stop_ev, _noxname_factory(txt, 0))
        finally:
            _nc_info.pop(cid, None)
...
async def cmd_ncdel(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    if not msg:
        return
    cid = msg.chat_id
    txt = _txt_arg(ctx) or "NOXNAME GOD"
    ncdel_chats.add(cid)
...
async def cmd_ncwar(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    if not msg:
        return
    cid = msg.chat_id
    txt = _txt_arg(ctx) or "NOXNAME GOD WAR"
...
async def main():
    ...
    print(f"[*] Starting {len(all_apps)} bots — NOXNAME GOD")
    ...
    if _hard_stop:
        print("[✓] NOXNAME GOD stopped.")
        return False       # caller exits

    print("[✓] NOXNAME GOD restarting…")
